...
my_336 = Model336(ip_address = '10.10.10.10')
print(my_336)
...
while True:
    ...
    payload = send_to_influxdb('336 Temperature Control', 'Williams College',
    datetime.datetime.utcnow(), my_336.get_all_sensor_reading()[1], my_336.get_control_setpoint(1))
